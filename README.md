...
8. If you plan to use slips, and you plan to use the slips sheet in the spreadsheet ([see below](https://github.com/ahlisbon/CJKmaterialProcessing#-how-the-spreadsheets-work)). if is imperative that you keep the physical books in precise order so that the other of the slips and the order of the books is the same.
